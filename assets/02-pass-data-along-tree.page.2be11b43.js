import{h as e}from"./vendor.47baf629.js";const n=[e("h1",{},["Pass data along tree"]),e("p",{},["You have a homogeneous component tree (e.g. nested comments, menus), and you want to pass data from parent to children."]),e("p",{},["Typical way of passing data to child components is to use props. However, this would expose implementation details in public API, and sometimes is not what you want. This also requires component user to correctly fill in props, if the component tree is composed by user:"]),e("pre",{},[`<menu-item title="File">
